...
<div x-data="{ mobileOpen: false, drawerOpen: false }"
  ...
  <header id="cc-main-nav"
    ...
    <div class="max-w-[1200px] mx-auto px-6 pt-3 pb-3 relative">
      ...
      <div class="hidden md:flex md:flex-col">
        ...
        <div class="flex items-center justify-between py-3 relative z-10">
          ...
          <a href="?view=home" class="hover:opacity-90 transition-opacity">
            <img src="assets/comedybreakinn-logo-white.png" alt="Comedy Break Inn" class="h-[140px] w-auto object-contain" />
          </a>
        ...
        <div class="flex items-stretch gap-4 py-2">
          <div class="flex-1 flex items-center gap-3 bg-black rounded-[10px] px-5 py-3 border border-white/10 overflow-hidden">
            ...
            <div class="flex-1 overflow-hidden">
              <span class="inline-block whitespace-nowrap text-sm font-bold text-neutral-300 animate-[marquee_60s_linear_infinite]">Get ready for a hilarious night out filled with non-stop laughs and unforgettable moments at Comedy Break Inn! Whether you're looking for the perfect date night, a fun outing with friends, or just a reason to laugh until your sides hurt, we've got the comedy, the craft beer, the wine, and so much more. Don't wait — secure your tickets today and treat yourself to an evening of world-class comedy and great drinks you won't want to miss!</span>
            </div>
          </div>
        </div>
      ...
      <div class="md:hidden flex items-center justify-between py-3">
        <a href="?view=home" class="hover:opacity-90 transition-opacity">
          <img src="assets/comedybreakinn-logo-white.png" alt="Comedy Break Inn" class="h-[100px] w-auto object-contain" />
        </a>
  ...
  <div x-cloak :class="mobileOpen ? 'translate-x-0' : 'translate-x-full'"
    ...
    <div class="p-8">
      ...
      <div class="flex justify-center mb-10">
        <a href="?view=home" class="hover:opacity-90 transition-opacity">
          <img src="assets/comedybreakinn-logo-white.png" alt="Comedy Break Inn" class="h-[120px] w-auto object-contain" />
        </a>
      </div>
      <nav class="space-y-4">
        <?php
        ...
        <div class="pl-4 mt-1 space-y-2 border-l border-white/10">
          ...
          <a href="#" @click="mobileOpen = false" class="block text-sm text-neutral-300 hover:text-white transition-colors py-1">Dropdown 2</a>
          <a href="#" @click="mobileOpen = false" class="block text-sm text-neutral-300 hover:text-white transition-colors py-1">Dropdown 3</a>
          <a href="#" @click="mobileOpen = false" class="block text-sm text-neutral-300 hover:text-white transition-colors py-1">Dropdown 4</a>
          <span class="block text-sm text-neutral-300">Dropdown 5</span>
          <div class="pl-4 space-y-1 border-l border-white/10">
            <a href="#" @click="mobileOpen = false" class="block text-sm text-neutral-400 hover:text-white transition-colors py-1">Dropdown 5-1</a>
            <a href="#" @click="mobileOpen = false" class="block text-sm text-neutral-400 hover:text-white transition-colors py-1">Dropdown 5-2</a>
            <a href="#" @click="mobileOpen = false" class="block text-sm text-neutral-400 hover:text-white transition-colors py-1">Dropdown 5-3</a>
          </div>
        </div>
      </nav>
  ...
  <div x-cloak :class="drawerOpen ? 'translate-x-0' : 'translate-x-full'"
    ...
    <div class="p-8">
      <div class="flex justify-between items-center mb-10">
        <span class="text-white font-bold text-lg">Menu</span>
        <button @click="drawerOpen = false" class="w-10 h-10 flex items-center justify-center rounded-[10px] bg-white/10 hover:bg-white/20 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
        </button>
      </div>
      <!-- Logo -->
      ...
      <nav class="space-y-4">
        ...
        <div class="pl-4 mt-1 space-y-2 border-l border-white/10">
          ...
          <a href="#" @click="drawerOpen = false" class="block text-sm text-neutral-300 hover:text-white transition-colors py-1">Dropdown 2</a>
          <a href="#" @click="drawerOpen = false" class="block text-sm text-neutral-300 hover:text-white transition-colors py-1">Dropdown 3</a>
          <a href="#" @click="drawerOpen = false" class="block text-sm text-neutral-300 hover:text-white transition-colors py-1">Dropdown 4</a>
          <span class="block text-sm text-neutral-300">Dropdown 5</span>
          <div class="pl-4 space-y-1 border-l border-white/10">
            <a href="#" @click="drawerOpen = false" class="block text-sm text-neutral-400 hover:text-white transition-colors py-1">Dropdown 5-1</a>
            <a href="#" @click="drawerOpen = false" class="block text-sm text-neutral-400 hover:text-white transition-colors py-1">Dropdown 5-2</a>
            <a href="#" @click="drawerOpen = false" class="block text-sm text-neutral-400 hover:text-white transition-colors py-1">Dropdown 5-3</a>
          </div>
        </div>
      </nav>
      <div class="mt-8 pt-6 border-t border-white/10 space-y-3">
