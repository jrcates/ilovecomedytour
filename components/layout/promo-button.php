...
<div class="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end">
  <a href="?view=design-system" class="flex items-center gap-2 px-5 py-3 bg-black hover:bg-neutral-800 text-white font-bold text-sm rounded-[10px] shadow-lg transition-colors">
