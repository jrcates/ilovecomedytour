<section class="py-16 relative overflow-hidden" x-data="{ viewMode: 'grid' }">
  <div class="max-w-[1200px] mx-auto px-4 md:px-6 relative z-10">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
      <h2 class="text-3xl md:text-4xl font-bold text-black tracking-tight"><?= htmlspecialchars($title) ?></h2>
      <div class="hidden md:flex items-center gap-1 border-l border-neutral-200 pl-4 ml-4">
      ...
      <div class="bg-white rounded-xl border border-neutral-200 shadow-md overflow-hidden flex flex-col">
        ...
        <div class="flex flex-col md:hidden">
          <div class="p-5 pb-3 flex flex-col gap-3">
            <h3 class="text-lg font-bold text-black"><?= htmlspecialchars($show['title']) ?></h3>
            ...
            <div class="inline-flex items-center gap-1.5 bg-neutral-100 text-neutral-600 text-xs font-medium px-3 py-1.5 rounded-full max-w-full w-fit">
            ...
            <a href="?view=event&show=<?= urlencode($show['id']) ?>" class="inline-block px-6 py-2.5 bg-black text-white font-bold text-sm rounded-[10px] hover:bg-neutral-800 transition-colors w-fit">Buy Tickets</a>
          </div>
        ...
        <div class="hidden md:flex md:flex-col flex-1">
          ...
          <div class="p-5 flex flex-col flex-1">
            <h3 class="text-lg font-bold text-black mb-3 line-clamp-2 min-h-[3.5rem]"><?= htmlspecialchars($show['title']) ?></h3>
    ...
    <div class="mt-10">
      <a href="<?= $linkUrl ?>" class="block w-full py-4 bg-black text-white font-bold text-center rounded-[10px] hover:bg-neutral-800 transition-colors text-sm"><?= htmlspecialchars($linkText ?? 'See Full Calendar') ?></a>
    </div>
    <?php endif; ?>
  </div>
</section>
