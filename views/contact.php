...
<div class="pt-12 pb-24 max-w-[1200px] mx-auto px-4 md:px-6">
  ...
  <div class="grid lg:grid-cols-2 gap-12 max-w-6xl items-start">
        ...
        <ul class="space-y-4">
          <li class="flex gap-4 items-start p-4 rounded-xl bg-white/5 border border-white/5">
            ...
            <div>
              ...
              <p class="text-neutral-400 text-sm">comedybreakin205@gmail.com</p>
            </div>
          </li>
          <li class="flex gap-4 items-start p-4 rounded-xl bg-white/5 border border-white/5">
            <div class="shrink-0 w-10 h-10 rounded-[10px] flex items-center justify-center text-[#d12027]">
            ...
            <div>
              ...
              <p class="text-neutral-400 text-sm">(000) 000-0000</p>
            </div>
          </li>
        </ul>
      </div>
    ...
    <!-- Right Column: Form -->
    <div class="bg-[#1e1e1e] pt-0 pb-8 px-8 md:px-10 rounded-xl border border-white/10 shadow-xl">
      <form method="POST" action="?view=contact" class="space-y-6">
        ...
        <div class="space-y-2">
          <label class="text-sm font-bold text-neutral-400 ml-1">Name</label>
          <input required type="text" name="name" placeholder="Your name" class="w-full bg-white/5 border border-white/10 rounded-[10px] p-4 text-white focus:ring-2 focus:ring-[#d12027] focus:border-transparent outline-none placeholder:text-neutral-400" />
        </div>
        <div class="space-y-2">
          <label class="text-sm font-bold text-neutral-400 ml-1">Email</label>
          <input required type="email" name="email" placeholder="your@email.com" class="w-full bg-white/5 border border-white/10 rounded-[10px] p-4 text-white focus:ring-2 focus:ring-[#d12027] focus:border-transparent outline-none placeholder:text-neutral-400" />
        </div>
        <div class="space-y-2">
          <label class="text-sm font-bold text-neutral-400 ml-1">Message</label>
          <textarea required name="message" rows="6" placeholder="How can we help you?" class="w-full bg-white/5 border border-white/10 rounded-[10px] p-4 text-white focus:ring-2 focus:ring-[#d12027] focus:border-transparent outline-none placeholder:text-neutral-400 resize-none"></textarea>
        </div>

        <button type="submit" class="w-full py-4 bg-white text-black font-bold text-lg rounded-[10px] hover:bg-neutral-200 transition-colors shadow-lg mt-4">Submit</button>
      </form>
    </div>
